				 ...
				 <label for="terminal" class="col-md-4 col-form-label text-md-right">{{ __('Terminal') }}</label>
                     <div class="form-select">
											...
											<option  value="">{{ 'Choose a terminal' }}</option>
											  ...
											  <option value="Varreux" >Varreux</option>
...
<script type="text/javascript">
    ...
    {
        var tr='<tr>'+
        '<td><select name="location_id[]" id= "location_id" class="form-control location_id"><option  value="">{{ "Choose a location" }}</option>@foreach($locations as $location)<option  value="{{ $location->id }}">{{ $location->address }}</option>@endforeach</select></td>'+
        '<td><input type="text" name="quantity[]" class="form-control quantity" required=""></td>'+
        '<td><input type="text" name="invnumber[]" class="form-control invnumber" required=""></td>'+
        '<td><a href="#" class="btn btn-danger remove"><i class="glyphicon glyphicon-remove"></i></a></td>'+
        '</tr>';
        $('tbody').append(tr);
    };
