<div class="app-header header-shadow" style="background-color: #008a74; color: white">
            <div class="app-header__logo">
                ...
                <div class="header__pane ml-auto">
                    <div style="font-size: 17px">
                        ...
                        <button type="button" class="hamburger close-sidebar-btn hamburger--elastic" data-class="closed-sidebar" style="color: white">
            ...
            <div class="app-header__mobile-menu">
                <div>
                    <button type="button" class="hamburger hamburger--elastic mobile-toggle-nav btn btn-warning">
                        <span class="hamburger-box">
                            <span class="hamburger-inner"></span>
                        </span>
                    </button>
