          ...
          <div class="widget-content-wrapper text-yellow">
                <div class="col-lg-18">
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab-eg7-0" role="tabpanel">
                                <div class="table-responsive" style="width:690px">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        <a href="" class="white-text mx-3">All</a>
                                        ...
                                        <div class="table-wrapper">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><i class="fa fa-truck" aria-hidden="true" style="color:blue"></i></td>
                                                    <td>MT-12</td>
                                                    <td><i class="fa fa-user" aria-hidden="true" style="color:blue"></i>&nbsp Jacob</td>
                                                    <td>THOR/JOA</td>
                                                    <td> <i style="color: red; font-size:large" class="pe-7s-attention btn-icon-wrapper"> </i></td>
                                                    <td>
                                                        <div class="progress-bar-sm progress" style="width:100px">
                                                        <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="71" aria-valuemin="0" aria-valuemax="100" style="width: 95%;"></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                                ...
                                                <td><i class="fa fa-truck" aria-hidden="true" style="color:green"></i></td>
                                                <td>LCM-01</td>
                                                <td><i class="fa fa-user" aria-hidden="true" style="color:green"></i>&nbsp Larry</td>
                                                <td>THOR/JOA</td>
                                                <td> <i style="color: red; font-size:large" class="pe-7s-attention btn-icon-wrapper"> </i></td>
                                                <td>
                                                    <div class="progress-bar-sm progress" style="width:100px">
                                                        <div class="progress-bar bg-success" role="progressbar" aria-valuenow="71" aria-valuemin="0" aria-valuemax="100" style="width: 39%;"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <td><i class="fa fa-truck" aria-hidden="true"  style="color:orange"></i></td>
                                                <td>LCM-02</td>
                                                <td><i class="fa fa-user" aria-hidden="true" style="color:orange"></i>&nbsp Paul</td>
                                                <td>THOR/JOA</td>
                                                <td> <i style="color: red; font-size:large" class="pe-7s-attention btn-icon-wrapper"> </i></td>
                                                <td>
                                                    <div class="progress-bar-sm progress" style="width:100px">
                                                        <div class="progress-bar bg-warning" role="progressbar" aria-valuenow="71" aria-valuemin="0" aria-valuemax="100" style="width: 51%;"></div>
                                                    </div>
                                                </td>
                                                </tr>
                                                <tr>
                                                ...
                                                <td><i class="fa fa-truck" aria-hidden="true" style="color:red"></i></td>
                                                <td>LCM-05</td>
                                                <td><i class="fa fa-user" aria-hidden="true" style="color:red"></i>&nbsp Larry</td>
                                                <td>THOR/JOA</td>
                                                <td> <i style="color: red; font-size:large" class="pe-7s-attention btn-icon-wrapper"></i></td>
                                                <td>
                                                    <div class="progress-bar-sm progress" style="width:100px">
                            ...
                            <div class="tab-pane" id="tab-eg7-1" role="tabpanel"> 
                                <div class="table-responsive" style="width:690px">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <a href="" class="white-text mx-3">Driving</a>
                                ...
                                <div class="tab-pane" id="tab-eg7-2" role="tabpanel">
                                    <div class="table-responsive" style="width:690px">
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <a href="" class="white-text mx-3">Parked</a>
              ...
              <div class="card-header">Transports
                  <div class="btn-actions-pane-right">
                      <div role="group" class="btn-group-sm btn-group">
                          <button class="active btn btn-focus">National</button>
                          <button class="btn btn-focus">Sodigaz</button>
                      </div>
                  </div>
              </div>
                                ...
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        ...
                                        <div class="widget-content-left flex2">
                                            <div class="widget-heading">BRN Distribution</div>
                                            <div class="widget-subheading opacity-7">Distribution BRN</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center">jeanjack@gmail.com</td>
                            <td class="text-center">
                              <div class="mb-2 mr-2 btn-transition btn btn-outline-success">Enock Jean Jacques</div>
                            </td>
                            <td class="text-center">
                              <div class="text-center">10, Nazon</div>
                              <!-- <div class="mb-3 progress">
                                  <div class="" role="" aria-valuenow="25" aria-valuemin="25" aria-valuemax="100" style="width: 25%;"></div>
                              </div> -->
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                            <i class="fa fa-building" aria-hidden="true" title="Copy to use building" style="color: orange;"> </i>
                                            </i>                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                                            <div class="widget-heading">Digicel</div>
                                            <div class="widget-subheading opacity-7">TIC</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center">mestime@gmail.com</td>
                            <td class="text-center">
                                <div class="mb-2 mr-2 btn-transition btn btn-outline-warning">M. Estime</div>
                            </td>
                            <td class="text-center">
                               Turjo
                            </td>
                            ...
                            <td>
                                <div class="widget-content p-0">
                                    <div class="widget-content-wrapper">
                                        <div class="widget-content-left mr-3">
                                            <div class="widget-content-left">
                                            <i class="fa fa-building" aria-hidden="true" title="Copy to use building" style="color: red;"> </i>
                                            </i>                                            </div>
                                        </div>
                                        <div class="widget-content-left flex2">
                                            <div class="widget-heading">Brana</div>
                                            <div class="widget-subheading opacity-7">Brasserie Nationale</div>
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="text-center">branahaiti@brana.ht</td>
                            <td class="text-center">
                                <div class="mb-2 mr-2 btn-transition btn btn-outline-danger">M.Brana</div>
                            </td>
                            <td class="text-center">
